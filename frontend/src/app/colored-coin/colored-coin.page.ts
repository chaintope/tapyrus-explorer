...
@Component({
  selector: 'app-colored-coin',
  templateUrl: './colored-coin.page.html',
  styleUrls: ['./colored-coin.page.scss'],
})
export class ColoredCoinPage implements OnInit {
  ...
  ngOnInit() {
    this.address = this.activatedRoute.snapshot.paramMap.get('coinId');
